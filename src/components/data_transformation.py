...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        ...
        ##dividing dataset into dependent and independent dataset
            ...
            logging.info(f"{input_feature_train_df.shape},{target_feature_train_df.shape}")
            #for test data
            ...
            logging.info('applying preprocessing on=bject in training and test data')
            ...
            logging.info('Execution occured in Data Transformation')
            raise CustomException(e, sys)
